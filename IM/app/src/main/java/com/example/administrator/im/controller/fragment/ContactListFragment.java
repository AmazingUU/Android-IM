...
import com.example.administrator.im.controller.activity.AddContactActivity;
...
public class ContactListFragment extends EaseContactListFragment {
    ...
    private View iv_contact_red;
    private LocalBroadcastManager mLBN;
    ...
    protected void setUpView() {
        ...
        //注册广播
        mLBN = LocalBroadcastManager.getInstance(getActivity());
        mLBN.registerReceiver(contactInviteChangeReceiver, new IntentFilter(Constant.CONTACT_INVITE_CHANGED));
        mLBN.registerReceiver(contactChangeReceiver, new IntentFilter(Constant.CONTACT_CHANGED));
        mLBN.registerReceiver(groupChangeReceiver,new IntentFilter(Constant.GROUP_INVITE_CHANGED));
    ...
    public void onDestroy() {
        ...
        mLBN.unregisterReceiver(contactInviteChangeReceiver);
        mLBN.unregisterReceiver(contactChangeReceiver);
        mLBN.unregisterReceiver(groupChangeReceiver);
    }
}
